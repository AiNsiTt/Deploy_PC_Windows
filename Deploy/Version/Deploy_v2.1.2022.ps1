...
Function Get-Head{
    ...
    Write-Host -Object "         PROGRAMME DE PREPARATION DE POSTE EMEDIA INFORMATIQUE         " -ForegroundColor "black"  -BackgroundColor "green"
    Write-Host -Object "                            Version 2.1.2022                           " -ForegroundColor "black"  -BackgroundColor "green"
    Write-Host -Object "                                                                       " -ForegroundColor "black"  -BackgroundColor "green"
...
# Proposition du numero de serie comme nom de poste
    ...
    Write-Host -Object " Voulez vous utiliser $SN comme nom de PC (OUI/NON) " -ForegroundColor "green" 
    $choix2 = read-host 
...
# Ajout des icones de base windows
    ...
    # Definition de la cle de registre du verouillage du pave numerique
        ...
        Write-Host -Object " Definition de la cle de registre du veroulliage du pave numerique " -ForegroundColor "black"  -BackgroundColor "green" 
...
# Reglage du chiffrage des disques
    ...
    ForEach ($Bitlocker in $BitlockerS) {
        ...
        Pause
            ...
            If ($BitlockerStatus -like "FullyEncrypted"){
                ...
                Write-Host -Object " Le disk $BitLockerMountpoint est chiffre via Bitlocker voulez vous le dechiffrer (OUI / NON) " -ForegroundColor "black"  -BackgroundColor "green"
                $ChoixBitlocker = read-host

                    If ($ChoixBitlocker -like "OUI"){
...
#Installation des Supports
    ...
    #DellCommandUpdate
        ...
        If ($Fab -like "Dell Inc."){ 
            ...
            Start-Process DellCommandUpdate.exe
    ...
    If ($choix -like "PRO"){
        ...
        # Installation go to assist
            ...
            # Copie de l'objet GoToAssist.exe situe dans C:\Deploy\ dans C:\Program Files\GoToAssist\
                ...
                Copy-item -Path "C:\Deploy\GoToAssist.exe" -Destination "C:\Program Files\GoToAssist\" 
        ...
        #=============================================================================================
            ...
            # Creation des cles de registre des informations de contact
                ...
                # Efface le contenu de la variable $ERROR
                    ...
                    Clear-variables -name "Error"

                # Nouvelle cle de registre (provoque une erreur si deja existant)

                    New-ItemProperty -Path $Info -name "Manufacturer" -value "E-NITIATIVE GROUPE"

            # Si $Error n'est pas vide alors on modIfie la cle de registre au lieu de la creer

                If ($Error -notlike $Null){
                    Set-ItemProperty -Path $Info -name "Manufacturer" -value "E-NITIATIVE GROUPE"
                }
...
# Attend la fin du procesus Ninite
